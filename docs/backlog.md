...
## PB-01 - Como professor quero que as questões da prova sejam corrigidas automaticamente para eu lançar as notas dos alunos
...
## PB-02 - Como professor quero criar uma prova e quero que ela fique armazenada para manter um histórico
...
## PB-03 - Como professor quero editar uma prova para mudar uma questão ou corrigir algum erro
- **Épico:** Gestão de Provas (CRUD)  
...
## PB-05 - Como professor quero visualizar todas as provas disponíveis no sistema para ter diferentes modelos para criar as minhas
- **Épico:** Gestão de Provas (CRUD)  
...
## PB-06 - Como aluno quero visualizar as provas associadas a mim para saber se fui bem nas provas que fiz e quais serão as próximas
...
## PB-07 - Como professor quero aplicar uma prova a um ou mais alunos para que ele realize a prova no sistema 
- **Épico:** Aplicação, Agendamento e Realização de Provas  
...
## PB-08 - Como professor quero agendar uma prova em uma data específica para que os alunos associados possam realizar naquele dia 
- **Épico:** Aplicação, Agendamento e Realização de Provas  
...
## PB-09 - Como aluno quero realizar as provas associdas a mim para ficar com nota acima da média na faculdade 
- **Épico:** Aplicação, Agendamento e Realização de Provas  
...
## PB-10 - Como professor quero salvar as provas em meu computador para enviar o arquivo da prova em outros canais de mensagem
...
## PB-11 - Como aluno quero salvar as minhas provas em meu computador para consulta-las depois com mais facilidade 
- **Épico:** Exportação de Arquivos  
...
## PB-12 - Como professor quero definir os pesos das questões para as questões mais difíceis valerem mais pontos 
